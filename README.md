...
Both graphs confirm that energy consumption is accelerating (non-linear pattern).
...
| File | Description |
|---|---|
| `case_study_5_electricity.py` | Main Python script — runs all computations and generates graphs |
| `case_study_5_graphs.png` | Output graphs (energy vs time, power vs time) |
| `case_study_5_documentation.docx` | Full written documentation with step-by-step solutions |
| `README.md` | This file |
...
|---|---|---|
| Central Difference | `P(t) = [E(t+h) - E(t-h)] / (2h)` | Estimate instantaneous power |
| Trapezoidal Rule | `(h/2) * [y0 + 2y1 + ... + 2yn-1 + yn]` | Estimate total area under curve |
